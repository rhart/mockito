...
import org.mockito.internal.stubbing.answers.DefaultValidableAnswer;
...
public class MockHandlerImpl<T> implements InternalMockHandler<T> {
    ...
    public Object handle(Invocation invocation) throws Throwable {
        ...
        if (stubbedInvocation != null) {
            ...
            Object ret = new DefaultValidableAnswer(mockSettings.getDefaultAnswer()).validatedAnswerFor(invocation);
